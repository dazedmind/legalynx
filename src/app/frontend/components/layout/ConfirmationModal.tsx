...
function ConfirmationModal({ 
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-full">
        <div 
          className={`bg-primary rounded-lg p-4 w-sm mx-4 border border-tertiary max-w-md shadow-xl transition-all duration-200 ease-out transform ${
            isVisible 
              ? 'scale-100 opacity-100' 
              : 'scale-95 opacity-0'
          }`}
        ...
        >
          ...
          <div className="text-center mb-4 px-4">
            <h3 className="text-xl font-semibold text-foreground mb-2">{modal.header}</h3>
            {documentName && (
